...
var Dino = function (_React$Component4) {
    _inherits(Dino, _React$Component4);

    function Dino() {
        _classCallCheck(this, Dino);

        return _possibleConstructorReturn(this, (Dino.__proto__ || Object.getPrototypeOf(Dino)).apply(this, arguments));
    }
...
var id_check = function id_check() {
    return new Promise(function (resolve) {
        switch (id) {
            //IDがない時は登録画面を表示する
            case null:
...
id_check().then(function () {
    $("#dino").click(function () {
        ReactDOM.render(React.createElement(Dino, null), $("#game").get(0));
    });
});